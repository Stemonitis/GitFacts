...
const languages = {
  ...
  "HTML+Django": {
    ...
    group: "HTML",
    extensions: [".jinja", ".j2", ".jinja2", ".njk"],
    aliases: [
      "django",
      "html+django/jinja",
      "html+jinja",
...
let optionsDef = [
  {
    ...
    input_secondLayer: languageArray.map((item) => ({
      htmlForAndInputId: "chooseLanguages",
      inputType: "checkbox",
      name: "language",
      query_value: item,
      title: item,
